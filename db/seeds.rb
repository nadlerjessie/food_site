...
proportions500 = Proportion.create(unit_id: units50.id, ingredient_id:ingredient201.id, quantity: 0.5, recipe_id:sandwich.id)
proportions501 = Proportion.create(unit_id: nil, ingredient_id:ingredient202.id, quantity:1, recipe_id:sandwich.id)
proportions502 = Proportion.create(unit_id: units53.id, ingredient_id:ingredient203.id, quantity: 0.5, recipe_id:sandwich.id)
...
proportions507 = Proportion.create(unit_id: units55.id, ingredient_id:ingredient208.id, quantity: 0.5, recipe_id:sandwich.id)
proportions508 = Proportion.create(unit_id: units50.id, ingredient_id:ingredient209.id, quantity: 0.25, recipe_id:sandwich.id)
proportions509 = Proportion.create(unit_id: nil, ingredient_id:ingredient210.id, quantity:2, recipe_id:sandwich.id)
proportions510 = Proportion.create(unit_id: nil, ingredient_id:ingredient211.id, quantity: 0.5, recipe_id:sandwich.id)
proportions511 = Proportion.create(unit_id: units53.id, ingredient_id:ingredient212.id, quantity: 0.75, recipe_id:sandwich.id)
